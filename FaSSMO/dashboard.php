...
<body class="w3-responsive w3-content">
    ...
    <nav class="w3-panel w3-text-black w3-tiny">
        ...
        <a class="w3-button w3-hover-yellow w3-hover-shadow w3-right" href="logout.php"><i class="material-icons w3-xlarge">backspace</i><br>Log Out</a>
        ...
        <div id="rec" class="w3-modal">
			    ...
			    //$today = date('Y-m-d');
                            ...
                            $sql = "SELECT * FROM timeoutcmpt INNER JOIN students on timeoutcmpt.studID = students.studID INNER JOIN timeincmpt on timeoutcmpt.studID = timeincmpt.studID WHERE timeincmpt.datein ORDER BY timeincmpt.num ASC";
			    $output = mysqli_query($conn,$sql);
                            foreach($output as $row){
                                echo "<tr class='w3-hover-blue w3-hover-shadow'>
                                <td>".$row['studID']."</td>
